          ...
          <div className="space-y-4 w-full">
            ...
            <div className="flex flex-col gap-3">
              <a
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && (window as any).ym) {
                    (window as any).ym(106851071, 'reachGoal', 'messenger_whatsapp');
                  }
                }}
              ...
              <a
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && (window as any).ym) {
                    (window as any).ym(106851071, 'reachGoal', 'messenger_telegram');
                  }
                }}
              ...
              <a
                ...
                onClick={() => {
                  if (typeof window !== 'undefined' && (window as any).ym) {
                    (window as any).ym(106851071, 'reachGoal', 'messenger_vk');
                  }
                }}
